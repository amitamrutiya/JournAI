...
export function Footer() {
  return (
    <footer className="bg-muted/50 relative border-t">
      {/* Background Pattern */}
      <div className="from-chart-5/5 to-secondary/5 absolute inset-0 bg-gradient-to-br via-transparent opacity-20" />
        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-foreground text-xl font-bold">JournAI</h3>
            </div>
            <p className="text-muted-foreground text-sm">
              Your AI-powered mood journal for better self-reflection and
              emotional awareness.
            </p>
          </div>
